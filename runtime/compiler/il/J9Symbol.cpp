   ...
   static F recognizedFieldName_j[] =
      {
       ...
       {r(TR::Symbol::Java_lang_invoke_ResolvedMethodName_vmtarget,   "java/lang/invoke/ResolvedMethodName", "vmtarget", "J")},
       {r(TR::Symbol::Java_lang_invoke_ResolvedMethodName_vmindex,    "java/lang/invoke/ResolvedMethodName", "vmindex", "J")},
